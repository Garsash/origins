...
#execute as @e[type=minecraft:ender_pearl,tag=enderian] unless block ~ ~-0.1 ~ air run function origins:enderian-shift/no_fall
execute at @e[type=minecraft:ender_pearl,tag=enderian] if score @e[type=minecraft:ender_pearl,tag=enderian,limit=1,sort=nearest,distance=..1] id = @s id run function origins:enderian-shift/pearl_check
...
execute if score @s origins.timeSinceDeath matches 1..3 run function origins:enderian-shift/spawn

function origins:enderian-shift/scary
#execute if entity @e[distance=16..32,type=iron_golem] run function origins:enderian-shift/scary
