...
execute if predicate origins:movement/w rotated ~ 0 positioned ^ ^ ^1 run function origins:phantom/forward

execute if predicate origins:movement/a rotated ~ 0 positioned ^1 ^ ^ run function origins:phantom/left

execute if predicate origins:movement/s rotated ~ 0 positioned ^ ^ ^-1 run function origins:phantom/backward

execute if predicate origins:movement/d rotated ~ 0 positioned ^-1 ^ ^ run function origins:phantom/right
