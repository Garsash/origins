...
execute if predicate origins:movement/space run function origins:phantom/movement/up
execute if predicate origins:movement/shift run function origins:phantom/movement/down

execute if predicate origins:movement/w rotated ~ 0 positioned ^ ^ ^1 run function origins:phantom/movement/forward

execute if predicate origins:movement/a rotated ~ 0 positioned ^1 ^ ^ run function origins:phantom/movement/left

execute if predicate origins:movement/s rotated ~ 0 positioned ^ ^ ^-1 run function origins:phantom/movement/backward

execute if predicate origins:movement/d rotated ~ 0 positioned ^-1 ^ ^ run function origins:phantom/movement/right
