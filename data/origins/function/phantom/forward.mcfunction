execute if predicate origins:no_collistion align xyz run function origins:phantom/block/try_make_intangible
...
execute if predicate origins:no_collistion rotated ~ 0 positioned ^-0.3 ^ ^ align xyz run function origins:phantom/block/try_make_intangible
