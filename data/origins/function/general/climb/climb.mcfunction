...
execute if predicate origins:movement/w run return run function origins:general/climb/climb_up
execute if predicate origins:movement/shift run return run function origins:general/climb/climb_stay