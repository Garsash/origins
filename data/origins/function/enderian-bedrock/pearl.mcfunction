...
execute as @s at @s rotated as @s run function origins:enderian-bedrock/spawn_pearl with entity @e[type=marker,tag=enderian_storage,limit=1,sort=nearest] data
