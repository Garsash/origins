...
###damage @s 1
##function origins:elytrian-shift/test
...
###function origins:elytrian-shift/summon_creeper with storage origins
##scoreboard players set $x player_motion.api.launch 0
##scoreboard players set $y player_motion.api.launch 16000
##scoreboard players set $z player_motion.api.launch 0
##function player_motion:api/launch_xyz
##advancement revoke @s only origins:elytrian-shift/boost
...
#kill @e[type=armor_stand,tag=test]
#function origins:elytrian-shift/summon_creeper with storage origins
#advancement revoke @s only origins:elytrian-shift/elytra
#stopsound @s * minecraft:entity.explode

#tag @s add boosted
#effect give @s minecraft:levitation 1 85
#scoreboard players set @s cooldown 320
#execute unless predicate origins:no_go_up run return run function origins:elytrian-shift/un_boost
#schedule function origins:elytrian-shift/boost_check 1t replace
