...
execute if score @s origins.shulk.handleDelay matches ..1 as @e[type=item,distance=1..] if items entity @s container.0 *[minecraft:custom_data={shulk:1b}] run function origins:shulk/box/handle_box
