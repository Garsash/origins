...
execute if function origins:bumblebee/space_check if score @s cooldown matches ..160 at @s unless function origins:scaled_ground_check/on_ground run return run function origins:bumblebee/levitation
...
execute at @s if function origins:scaled_ground_check/on_ground run scoreboard players set @s effect_cooldown 0
