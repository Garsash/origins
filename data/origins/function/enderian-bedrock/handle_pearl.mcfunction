...
execute at @s positioned ~ ~-0.01 ~ if function origins:scaled_ground_check/on_ground run return fail

execute if score @s cooldown matches ..0 run function origins:enderian-bedrock/pearl