...
item replace entity @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=flying] weapon.mainhand from entity @s weapon.offhand
item replace entity @s weapon.offhand with poisonous_potato[!food,minecraft:custom_model_data={floats:[1]},minecraft:custom_name='{"text":""}',minecraft:custom_data={Elytrian:1b}]
