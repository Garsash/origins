...
execute if predicate hit_match:has_uid run scoreboard players operation $source ehm._ = @s ehm.id

# ...
scoreboard players set $is_direct_source ehm._ 0
execute if entity @s[advancements={hit_match:player_hurt_entity={direct_damage=true}}] run scoreboard players set $is_direct_source ehm._ 1
