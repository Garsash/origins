...
execute unless data storage hit_match:data _.func."death_detect.track".temp.poll run function hit_match:_death_detect/track/_71
...
# ...
$data remove storage hit_match:data _.death_detect.polls[{poll_rate:$(poll_rate)}]
data modify storage hit_match:data _.death_detect.polls append from storage hit_match:data _.func."death_detect.track".temp.poll
