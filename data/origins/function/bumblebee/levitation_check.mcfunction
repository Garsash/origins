...
execute if score @s cooldown matches ..150 at @s unless function origins:scaled_ground_check/on_ground if predicate origins:sneak run return run function origins:bumblebee/levitation
