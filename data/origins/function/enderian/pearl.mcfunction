...
execute as @s at @s rotated as @s run function origins:enderian/spawn_pearl with entity @e[type=marker,tag=enderian_storage,limit=1,sort=nearest] data
...
schedule function origins:enderian/re_pearl 1t replace